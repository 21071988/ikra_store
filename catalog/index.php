...
<div class="wrapper wrapper__catalog">
  <div class="left__part">
    ...
    <div class="catalog__menu__brands">
    <b>Бренды</b>
      <a href="">Платья</a>
      <a href="">топ</a>
      <a href="">юбки</a>
  ...
  <div class="catalog__part  right__part">
    ...
    <form action="">
      ...
      <div class="top__menu__chooses">
        ...
        <div class="top__menu__choose__type top__menu__choose its__block">
        <label class='top__menu__choose__color possibly__active' for="rings"><input type="checkbox" id="rings" name='size' value='rings' checked> rings</label>
